...
export const DEMO_PRODUCTS = [
  {
    ...
    description: "Fully compliant packaged commodity adhering to all 10 QA screening rules, with the public identity check intentionally marked not applicable for demo data.",
    highlights: [
