      ...
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="block w-full pl-9 pr-3 py-2 text-xs rounded-lg border border-slate-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-slate-900 bg-slate-50"
          />
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
        {filteredInspections.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h4 className="text-sm font-bold text-slate-800">No matching audits found</h4>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50/50 text-[11px] font-bold uppercase tracking-wider text-slate-500">
                  <th className="py-3.5 px-6">Audit Reference</th>
                  <th className="py-3.5 px-6">Packaged Commodity</th>
                  <th className="py-3.5 px-6">Category</th>
                  <th className="py-3.5 px-6">QA Determination</th>
